...
<template>
    ...
    <OfficeLayout>
        ...
        <template #content>
            <section
                class="rounded-lg bg-white antialiased shadow-md dark:bg-gray-900"
            >
                ...
                <div
                    class="relative overflow-hidden border-b border-t bg-white dark:bg-gray-800 sm:rounded-b-lg"
                >
                    <div
